    ...
    <div class="row headline"><!-- Begin Headline -->
        ...
        <div class="span8">
            <div class="flexslider">
              <ul class="slides">
                <li><a href="gallery-single.htm"><img src="<?php echo base_url() ?>assets/img/gallery/slider-img-1.jpg" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="<?php echo base_url() ?>assets/img/gallery/slider-img-1.jpg" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="<?php echo base_url() ?>assets/img/gallery/slider-img-1.jpg" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="<?php echo base_url() ?>assets/img/gallery/slider-img-1.jpg" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="<?php echo base_url() ?>assets/img/gallery/slider-img-1.jpg" alt="slider" /></a></li>
        ...
        <div class="container">
            <div class="row footer-row">
                <div class="span3 footer-col">
                    <h5>About Us</h5>
                   <img src="<?php echo base_url() ?>assets/img/piccolo-footer-logo.png" alt="Piccolo" /><br /><br />
                    <address>
